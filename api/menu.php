...
SQL;
    ...
    $items = array_map(static function (array $row): array {
        return [
            ...
            'menuId' => $row['menu_id'] !== null ? (string) $row['menu_id'] : null,
            'menuName' => $row['menu_name'] !== null ? (string) $row['menu_name'] : null,
            'subMenuId' => $row['sub_menu_id'] !== null ? (string) $row['sub_menu_id'] : null,
            'subMenuName' => $row['sub_menu_name'] !== null ? (string) $row['sub_menu_name'] : null,
            'websiteSet' => $row['website_set'] !== null ? (string) $row['website_set'] : null,
            'businessSet' => $row['business_set'] !== null ? (string) $row['business_set'] : null,
