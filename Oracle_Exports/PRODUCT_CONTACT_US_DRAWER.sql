--------------------------------------------------------
--  DDL for Function PRODUCT_CONTACT_US_DRAWER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "WEB"."PRODUCT_CONTACT_US_DRAWER" 
    ...
    IF p_device_type = 'DESKTOP' THEN
        ...
        '<div id="'|| c_product_rec.ANCHOR_ID || '" class="centered">';
         ...
         IF c_product_rec.PRODUCT_IMAGE_LARGE is not null
            then
                 v_grid_html := v_grid_html ||'<div class="centered-image "><img class="fx animated fadeInLeft " alt="" src="' || PRODUCT_IMAGE_DISPLAY(NVL(NULLIF(SYS_CONTEXT('APEX$SESSION','WORKSPACE'),''),'SYNTEC'),'assets/images/Scientific/suppliers/',c_product_rec.PRODUCT_IMAGE_LARGE,c_product_rec.PRODUCT_IMAGE_EXTERNAL)  || '" ' ||
...
<!-- ? Drawer reCAPTCHA -->
<div                id="recaptcha-drawer" class="xxxxxx"></div>
...
<input type="submit" id="send-message-drawer"
    ...
    ELSE
        ...
        '<div id="'|| c_product_rec.ANCHOR_ID || '" class="centered">';
                 ...
                 v_grid_html := v_grid_html ||'<div class="centered-image "><img class="fx animated fadeInLeft img-mobile-40" alt="" src="' || PRODUCT_IMAGE_DISPLAY(NVL(NULLIF(SYS_CONTEXT('APEX$SESSION','WORKSPACE'),''),'SYNTEC'),'assets/images/Scientific/suppliers/',c_product_rec.PRODUCT_IMAGE_LARGE,c_product_rec.PRODUCT_IMAGE_EXTERNAL)  || '" ' ||
                    'style="margin-bottom:30px; ' ||
                    ' height: 200px;' 
                    || '"/></div>' ||
