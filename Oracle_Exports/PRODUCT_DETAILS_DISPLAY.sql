--------------------------------------------------------
--  DDL for Function PRODUCT_DETAILS_DISPLAY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "WEB"."PRODUCT_DETAILS_DISPLAY" 
(p_device_type IN VARCHAR2, p_workspace_url IN VARCHAR2, p_product_id IN VARCHAR2, p_Show_related IN VARCHAR2)
...
BEGIN
    ...
    IF p_device_type = 'DESKTOP' THEN
        ...
        '<div id="'|| c_product_rec.ANCHOR_ID || '" class="container-syn padding-vertical-30">' ||
            '<div class="row">' ||
