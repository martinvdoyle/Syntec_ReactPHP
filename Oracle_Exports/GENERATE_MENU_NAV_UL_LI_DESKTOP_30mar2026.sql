--------------------------------------------------------
--  DDL for Function GENERATE_MENU_NAV_UL_LI_DESKTOP_30mar2026
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "WEB"."GENERATE_MENU_NAV_UL_LI_DESKTOP_30mar2026" (
        ...
        DECLARE v_sub_menu_exists NUMBER; BEGIN
          ...
          IF v_sub_menu_exists > 0 THEN
            v_menu_html := v_menu_html || '<ul id="' || v_menu_name || '" '||
               (CASE 
                    WHEN v_menu_class LIKE '%mega-menu%' and v_device_type = 'DESKTOP' THEN 'class="mega-menu_pos"'
                    ELSE NULL 
                END) || '> ';
              ...
              DECLARE v_sub_sub_menu_exists NUMBER; BEGIN
                ...
                IF v_sub_sub_menu_exists > 0 THEN
                  ...
                  FOR r_sub_sub IN (
                    ...
                    v_menu_html := v_menu_html || '<div><span>' || v_menu_name || '</span>';
