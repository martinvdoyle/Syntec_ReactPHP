--------------------------------------------------------
--  DDL for Function PRODUCT_DETAILS1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "WEB"."PRODUCT_DETAILS1" 
(p_device_type IN VARCHAR2, p_workspace_url IN VARCHAR2,p_RELATED_PRODUCTS  IN VARCHAR2, p_PRODUCT_GROUP_ALT IN VARCHAR2, p_PRODUCT_TYPE IN VARCHAR2, 
